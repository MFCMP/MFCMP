...
2. If it doesn't work, then try to install an older JDK version, set its installation folder to "java.home" user setting in `.vscode/settings.json` and reopen your VS Code workspace.
